...
resourceString
  ...
  rsfdFileAlreadyExists  = 'O arquivo "%s" já existe. Deseja sobrescrever?';
  ...
  // DBGrid
  rsDeleteRecord = 'Deseja realmente apagar o registro?';
  ...
  rsInsertRecordHint = 'Salvar';
  rsDeleteRecordHint = 'Apagar';
  rsEditRecordHint = 'Alterar';
  rsPostRecordHint = 'Gravar';
